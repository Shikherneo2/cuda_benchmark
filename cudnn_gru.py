...
from support import toy_batch16, default_params, write_results, print_results, check_results
...
# Get data
bX, b_lenX, bY, classes = toy_batch16()
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.lstm = nn.GRU(input_size=inp_dims, hidden_size=rnn_size, num_layers=1, bias=True, bidirectional=False)
